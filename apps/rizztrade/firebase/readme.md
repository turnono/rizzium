...
* `firebase.rizztrade-firebase.json` - Firebase CLI Configuration for this project
...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp rizztrade-firebase` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run rizztrade-firebase:deploy` - Deploy this app to firebase
* `nx run rizztrade-firebase:serve` - Serve this app using the firebase emulator
* `nx run rizztrade-firebase:build` - Build all functions associated with this app
* `nx run rizztrade-firebase:test` - Test all functions associated with this app
* `nx run rizztrade-firebase:lint` - Lint all functions associated with this app

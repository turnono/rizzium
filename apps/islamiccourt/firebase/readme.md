...
* `firebase.islamiccourt-firebase.json` - Firebase CLI Configuration for this project
...
* `nx g @simondotm/nx-firebase:function my-function --firebaseApp islamiccourt-firebase` - Add a firebase function to this project

See the plugin [README](https://github.com/simondotm/nx-firebase/blob/main/README.md) for more information.

## Commands

* `nx run islamiccourt-firebase:deploy` - Deploy this app to firebase
* `nx run islamiccourt-firebase:serve` - Serve this app using the firebase emulator
* `nx run islamiccourt-firebase:build` - Build all functions associated with this app
* `nx run islamiccourt-firebase:test` - Test all functions associated with this app
* `nx run islamiccourt-firebase:lint` - Lint all functions associated with this app
